        ...
        show: function() {
            if (this.clearTimer("hide"), !this.visible() && !this.is("disabled") && $(this.target).is(":visible")) {
                ...
                this.is("updated") || this.is("updating") || a.queue($.proxy(function(a) {
                    ...
                    if ("function" == $.type(this._cache.refreshCallbackAfterSanitize)) {
                        var b = new Visible(this._tooltip);
                        this._cache.refreshCallbackAfterSanitize(this._content[0], this.element), b.restore(), this._cache.refreshCallbackAfterSanitize = null
                    }
                    a()
                }, this)), a.queue($.proxy(function(a) {
